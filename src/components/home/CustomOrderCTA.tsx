      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="relative rounded-[3rem] bg-gradient-to-b from-[#FDE9E5] via-[#FFF8F5] to-[#FDE9E5] border border-[#E8D4CF] p-8 sm:p-14 lg:p-16 shadow-boutique overflow-hidden">
          ...
          <div className="max-w-2xl mx-auto space-y-6 relative z-10">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-[#E8D4CF] text-xs font-semibold text-[#8F3032] shadow-2xs transition-all duration-300">
            ...
            <div className="space-y-2 min-h-[130px] sm:min-h-[150px] lg:min-h-[170px] flex flex-col justify-center">
              <h2
                className={`font-serif-luxury text-3xl sm:text-4xl lg:text-5xl font-bold text-[#3A211D] tracking-tight leading-[1.15] transition-all duration-300 ease-out transform ${
                  isFading
            ...
            {/* Description */}
            <p
              className={`text-base sm:text-lg text-[#78635E] leading-relaxed transition-opacity duration-300 min-h-[56px] ${
              ...
              {ROTATING_TITLES.map((_, i) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-300 cursor-pointer ${
                    index === i
                      ? "w-6 bg-[#8F3032]"
                      : "w-1.5 bg-[#E8D4CF] hover:bg-[#E9AAA3]"
                  }`}
            ...
            <div className="pt-2">
              <Link
                href="/custom-order"
                className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-[#8F3032] text-white text-sm font-semibold hover:bg-[#722628] shadow-md hover:shadow-boutique-hover transition-all active:scale-95 group"
              >
